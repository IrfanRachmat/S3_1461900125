...
<html lang="en">
  ...
  <body style="background-color: #ffe6f7";>
    @include('sweetalert::alert')
    <div class="container" style="margin-top: 10px;">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"style="background-color: lightblue";>Kelas</div>
                    <div class="card-body">
                ...
                {{-- Master Barang --}}
                <div class="card">
                    <div class="card-header"style="background-color: lightblue";>Daftar Guru</div>
                    <div class="card-body">
